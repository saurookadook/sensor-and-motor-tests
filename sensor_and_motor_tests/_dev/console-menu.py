...
"""from 'ev3dev-lang-python-demo': https://github.com/ev3dev/ev3dev-lang-python-demo/blob/stretch/robots/misc/console_menu.py"""
...
def get_positions(console):
    ...
    Returns:
        dict: a Dictionary of Tuples keyed by button names with column/row location
    """
...
def wait_for_button_press(button):
    ...
    Returns:
        pressed (str): the Button name that was pressed.
    """
    pressed = None
    while True:
